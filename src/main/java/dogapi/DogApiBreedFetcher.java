...
public class DogApiBreedFetcher implements BreedFetcher {
    ...
    public List<String> getSubBreeds(String breed) throws BreedNotFoundException {
        ...
        try (Response response = client.newCall(request).execute()) {
            ...
            JSONArray subBreedsJson = jsonObject.getJSONArray("message");
            ...
            throw new BreedNotFoundException("Error retrieving data for breed: " + breed);
        } catch (Exception e) {
            // Catch-all for any unexpected JSON parsing or API issues
